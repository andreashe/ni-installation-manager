...
**[⬇ Download NI-Installation-Manager-Setup.exe](https://github.com/OWNER/REPO/releases/latest/download/NI-Installation-Manager-Setup.exe)**

> Replace `OWNER/REPO` above once this repository has a GitHub remote.
